...
<html>
    ...
    <body>
        <header>
            ...
            <nav  id="menu">
                <ul>
                    <li><a href="index.php?uc=accueil&action=voirTout"> Accueil </a></li>
                    ...
                    <li><a href="index.php?uc=creation">ajouter un jeu</a></li>
                </ul>
            </nav>
        ...
        <main>
            ...
            switch ($uc) {
                ...
                case 'compte' :
                    ...
                    break;
                case 'creation' :
                    include ("App/vue/v_creation.php");
                    break;
                case 'connection' :
                ...
                case 'inscription' :
                    ...
                    break;
                case 'moncompte' :
                    include ("App/vue/v_mon_compte.php");
                    break;
                default:
                    break;
            }
